import*as e from"../../core/common/common.js";import*as t from"../../core/sdk/sdk.js";import*as i from"../../core/i18n/i18n.js";import*as o from"../../core/root/root.js";import*as s from"../../ui/legacy/components/color_picker/color_picker.js";import*as n from"../../ui/legacy/legacy.js";import*as r from"../../core/platform/platform.js";import*as a from"../../models/text_utils/text_utils.js";import*as l from"../../ui/components/icon_button/icon_button.js";import*as d from"../../ui/legacy/components/data_grid/data_grid.js";import*as c from"../../ui/legacy/components/utils/utils.js";import*as h from"../../ui/visual_logging/visual_logging.js";import*as u from"./components/components.js";import*as p from"../../core/host/host.js";class v extends e.ObjectWrapper.ObjectWrapper{currentUrl;constructor(){super(),this.currentUrl=t.TargetManager.TargetManager.instance().inspectedURL(),t.TargetManager.TargetManager.instance().addEventListener("InspectedURLChanged",this.#e,this)}#e(){this.currentUrl!==t.TargetManager.TargetManager.instance().inspectedURL()&&(this.currentUrl=t.TargetManager.TargetManager.instance().inspectedURL(),this.dispatchEventToListeners("Reset"))}}var m=Object.freeze({__proto__:null,OverviewController:v});const g={topAppliedToAStatically:"`Top` applied to a statically positioned element",leftAppliedToAStatically:"`Left` applied to a statically positioned element",rightAppliedToAStatically:"`Right` applied to a statically positioned element",bottomAppliedToAStatically:"`Bottom` applied to a statically positioned element",widthAppliedToAnInlineElement:"`Width` applied to an inline element",heightAppliedToAnInlineElement:"`Height` applied to an inline element",verticalAlignmentAppliedTo:"Vertical alignment applied to element which is neither `inline` nor `table-cell`"},f=i.i18n.registerUIStrings("panels/css_overview/CSSOverviewUnusedDeclarations.ts",g),w=i.i18n.getLocalizedString.bind(void 0,f);class b{static add(e,t,i){const o=e.get(t)||[];o.push(i),e.set(t,o)}static checkForUnusedPositionValues(e,t,i,o,s,n,r,a){if("static"===i[o]){if("auto"!==i[s]){const o=w(g.topAppliedToAStatically);this.add(e,o,{declaration:`top: ${i[s]}`,nodeId:t})}if("auto"!==i[n]){const o=w(g.leftAppliedToAStatically);this.add(e,o,{declaration:`left: ${i[n]}`,nodeId:t})}if("auto"!==i[r]){const o=w(g.rightAppliedToAStatically);this.add(e,o,{declaration:`right: ${i[r]}`,nodeId:t})}if("auto"!==i[a]){const o=w(g.bottomAppliedToAStatically);this.add(e,o,{declaration:`bottom: ${i[a]}`,nodeId:t})}}}static checkForUnusedWidthAndHeightValues(e,t,i,o,s,n){if("inline"===i[o]){if("auto"!==i[s]){const o=w(g.widthAppliedToAnInlineElement);this.add(e,o,{declaration:`width: ${i[s]}`,nodeId:t})}if("auto"!==i[n]){const o=w(g.heightAppliedToAnInlineElement);this.add(e,o,{declaration:`height: ${i[n]}`,nodeId:t})}}}static checkForInvalidVerticalAlignment(e,t,i,o,s){if(i[o]&&!i[o].startsWith("inline")&&!i[o].startsWith("table")&&"baseline"!==i[s]){const o=w(g.verticalAlignmentAppliedTo);this.add(e,o,{declaration:`vertical-align: ${i[s]}`,nodeId:t})}}}var S=Object.freeze({__proto__:null,CSSOverviewUnusedDeclarations:b});class C extends t.SDKModel.SDKModel{#t;#i;#o;#s;constructor(e){super(e),this.#t=e.runtimeAgent(),this.#i=e.cssAgent(),this.#o=e.domsnapshotAgent(),this.#s=e.overlayAgent()}highlightNode(t){const i={contentColor:e.Color.PageHighlight.Content.toProtocolRGBA(),showInfo:!0,contrastAlgorithm:o.Runtime.experiments.isEnabled("apca")?"apca":"aa"};this.#s.invoke_hideHighlight(),this.#s.invoke_highlightNode({backendNodeId:t,highlightConfig:i})}async getNodeStyleStats(){const t=new Map,i=new Map,n=new Map,r=new Map,a=new Map,l=new Map,d=new Map,c=t=>t instanceof e.Color.Legacy?t.hasAlpha()?t.asString("hexa"):t.asString("hex"):t.asString(),h=(t,i,o)=>{if(-1===t)return;const s=f[t];if(!s)return;const n=e.Color.parse(s);if(!n||0===n.asLegacyColor().rgba()[3])return;const r=c(n);if(!r)return;const a=o.get(r)||new Set;return a.add(i),o.set(r,a),n},u=e=>new Set(["altglyph","circle","ellipse","path","polygon","polyline","rect","svg","text","textpath","tref","tspan"]).has(e.toLowerCase()),p=e=>new Set(["iframe","video","embed","img"]).has(e.toLowerCase()),v=(e,t)=>new Set(["tr","td","thead","tbody"]).has(e.toLowerCase())&&t.startsWith("table");let m=0;const{documents:g,strings:f}=await this.#o.invoke_captureSnapshot({computedStyles:["background-color","color","fill","border-top-width","border-top-color","border-bottom-width","border-bottom-color","border-left-width","border-left-color","border-right-width","border-right-color","font-family","font-size","font-weight","line-height","position","top","right","bottom","left","display","width","height","vertical-align"],includeTextColorOpacities:!0,includeBlendedBackgroundColors:!0});for(const{nodes:w,layout:S}of g){m+=S.nodeIndex.length;for(let m=0;m<S.styles.length;m++){const g=S.styles[m],C=S.nodeIndex[m];if(!w.backendNodeId||!w.nodeName)continue;const y=w.backendNodeId[C],x=w.nodeName[C],[k,I,$,M,T,E,A,L,F,O,R,V,_,N,P,D,W,z,B,U,j,H,G,q]=g;h(k,y,t);const Q=h(I,y,i);if(u(f[x])&&h($,y,r),"0px"!==f[M]&&h(T,y,a),"0px"!==f[E]&&h(A,y,a),"0px"!==f[L]&&h(F,y,a),"0px"!==f[O]&&h(R,y,a),V&&-1!==V){const e=f[V],t=l.get(e)||new Map,i="font-size",o="font-weight",s="line-height",n=t.get(i)||new Map,r=t.get(o)||new Map,a=t.get(s)||new Map;if(-1!==_){const e=f[_],t=n.get(e)||[];t.push(y),n.set(e,t)}if(-1!==N){const e=f[N],t=r.get(e)||[];t.push(y),r.set(e,t)}if(-1!==P){const e=f[P],t=a.get(e)||[];t.push(y),a.set(e,t)}t.set(i,n),t.set(o,r),t.set(s,a),l.set(e,t)}const K=Q&&S.blendedBackgroundColors&&-1!==S.blendedBackgroundColors[m]?e.Color.parse(f[S.blendedBackgroundColors[m]]):null;if(Q&&K){const e=new s.ContrastInfo.ContrastInfo({backgroundColors:[K.asString("hexa")],computedFontSize:-1!==_?f[_]:"",computedFontWeight:-1!==N?f[N]:""}),t=Q.asLegacyColor().blendWithAlpha(S.textColorOpacities?S.textColorOpacities[m]:1);e.setColor(t);const i=`${c(t)}_${c(K.asLegacyColor())}`;if(o.Runtime.experiments.isEnabled("apca")){const o=e.contrastRatioAPCA(),s=e.contrastRatioAPCAThreshold();if(!(!(!o||!s)&&Math.abs(o)>=s)&&o){const e={nodeId:y,contrastRatio:o,textColor:t,backgroundColor:K,thresholdsViolated:{aa:!1,aaa:!1,apca:!0}};n.has(i)?n.get(i).push(e):n.set(i,[e])}}else{const o=e.contrastRatioThreshold("aa")||0,s=e.contrastRatioThreshold("aaa")||0,r=e.contrastRatio()||0;if(o>r||s>r){const e={nodeId:y,contrastRatio:r,textColor:t,backgroundColor:K,thresholdsViolated:{aa:o>r,aaa:s>r,apca:!1}};n.has(i)?n.get(i).push(e):n.set(i,[e])}}}b.checkForUnusedPositionValues(d,y,f,D,W,U,z,B),u(f[x])||p(f[x])||b.checkForUnusedWidthAndHeightValues(d,y,f,j,H,G),-1===q||v(f[x],f[j])||b.checkForInvalidVerticalAlignment(d,y,f,j,q)}}return{backgroundColors:t,textColors:i,textColorContrastIssues:n,fillColors:r,borderColors:a,fontInfo:l,unusedDeclarations:d,elementCount:m}}getComputedStyleForNode(e){return this.#i.invoke_getComputedStyleForNode({nodeId:e})}async getMediaQueries(){const e=await this.#i.invoke_getMediaQueries(),t=new Map;if(!e)return t;for(const i of e.medias){if("linkedSheet"===i.source)continue;const e=t.get(i.text)||[];e.push(i),t.set(i.text,e)}return t}async getGlobalStylesheetStats(){const{result:e}=await this.#t.invoke_evaluate({expression:"(function() {\n      let styleRules = 0;\n      let inlineStyles = 0;\n      let externalSheets = 0;\n      const stats = {\n        // Simple.\n        type: new Set(),\n        class: new Set(),\n        id: new Set(),\n        universal: new Set(),\n        attribute: new Set(),\n\n        // Non-simple.\n        nonSimple: new Set()\n      };\n\n      for (const styleSheet of document.styleSheets) {\n        if (styleSheet.href) {\n          externalSheets++;\n        } else {\n          inlineStyles++;\n        }\n\n        // Attempting to grab rules can trigger a DOMException.\n        // Try it and if it fails skip to the next stylesheet.\n        let rules;\n        try {\n          rules = styleSheet.rules;\n        } catch (err) {\n          continue;\n        }\n\n        for (const rule of rules) {\n          if ('selectorText' in rule) {\n            styleRules++;\n\n            // Each group that was used.\n            for (const selectorGroup of rule.selectorText.split(',')) {\n              // Each selector in the group.\n              for (const selector of selectorGroup.split(/[\\t\\n\\f\\r ]+/g)) {\n                if (selector.startsWith('.')) {\n                  // Class.\n                  stats.class.add(selector);\n                } else if (selector.startsWith('#')) {\n                  // Id.\n                  stats.id.add(selector);\n                } else if (selector.startsWith('*')) {\n                  // Universal.\n                  stats.universal.add(selector);\n                } else if (selector.startsWith('[')) {\n                  // Attribute.\n                  stats.attribute.add(selector);\n                } else {\n                  // Type or non-simple selector.\n                  const specialChars = /[#.:\\[\\]|\\+>~]/;\n                  if (specialChars.test(selector)) {\n                    stats.nonSimple.add(selector);\n                  } else {\n                    stats.type.add(selector);\n                  }\n                }\n              }\n            }\n          }\n        }\n      }\n\n      return {\n        styleRules,\n        inlineStyles,\n        externalSheets,\n        stats: {\n          // Simple.\n          type: stats.type.size,\n          class: stats.class.size,\n          id: stats.id.size,\n          universal: stats.universal.size,\n          attribute: stats.attribute.size,\n\n          // Non-simple.\n          nonSimple: stats.nonSimple.size\n        }\n      }\n    })()",returnByValue:!0});if("object"===e.type)return e.value}}t.SDKModel.SDKModel.register(C,{capabilities:2,autostart:!1});var y=Object.freeze({__proto__:null,CSSOverviewModel:C});const x=new CSSStyleSheet;x.replaceSync(".overview-processing-view{overflow:hidden;padding:16px;justify-content:center;align-items:center;height:100%}.overview-processing-view h1{font-size:16px;text-align:center;font-weight:normal;margin:0;padding:8px}.overview-processing-view h2{font-size:12px;text-align:center;font-weight:normal;margin:0;padding-top:32px}\n/*# sourceURL=cssOverviewProcessingView.css */\n");const k={cancel:"Cancel"},I=i.i18n.registerUIStrings("panels/css_overview/CSSOverviewProcessingView.ts",k),$=i.i18n.getLocalizedString.bind(void 0,I);class M extends n.Widget.Widget{#n;fragment;constructor(e){super(),this.#n=e,this.#r()}#r(){const e=n.UIUtils.createTextButton($(k.cancel),(()=>this.#n.dispatchEventToListeners("RequestOverviewCancel")),{jslogContext:"css-overview.cancel-processing",primary:!0});this.setDefaultFocusedElement(e),this.fragment=n.Fragment.Fragment.build`
    ...
    <div class="vbox overview-completed-view">
      ...
      <div $="colors" class="results-section horizontally-padded colors">
        <h1>${P(_.colors)}</h1>
        <h2>${P(_.backgroundColorsS,{PH1:u.length})}</h2>
        <ul>
          ${u.map(this.#T.bind(this,"background"))}
        </ul>

        <h2>${P(_.textColorsS,{PH1:p.length})}</h2>
        <ul>
          ${p.map(this.#T.bind(this,"text"))}
        </ul>

        ${s.size>0?this.#E(s):""}

        <h2>${P(_.fillColorsS,{PH1:v.length})}</h2>
        <ul>
          ${v.map(this.#T.bind(this,"fill"))}
        </ul>

        <h2>${P(_.borderColorsS,{PH1:m.length})}</h2>
        <ul>
          ${m.map(this.#T.bind(this,"border"))}
        </ul>
      </div>

      <div $="font-info" class="results-section font-info">
        <h1>${P(_.fontInfo)}</h1>
        ${h.size>0?this.#A(h):n.Fragment.Fragment.build`<div>${P(_.thereAreNoFonts)}</div>`}
      </div>

      <div $="unused-declarations" class="results-section unused-declarations">
        <h1>${P(_.unusedDeclarations)}</h1>
        ${c.size>0?this.#L(c,"unused-declarations","declaration"):n.Fragment.Fragment.build`<div class="horizontally-padded">${P(_.thereAreNoUnusedDeclarations)}</div>`}
      </div>

      <div $="media-queries" class="results-section media-queries">
        <h1>${P(_.mediaQueries)}</h1>
        ${d.size>0?this.#L(d,"media-queries","text"):n.Fragment.Fragment.build`<div class="horizontally-padded">${P(_.thereAreNoMediaQueries)}</div>`}
      </div>
    </div>`,this.#v.element.appendChild(this.#y.element())}#I(e){const{payload:t}=e.data;let i="",o="";switch(t.type){case"contrast":{const{section:e,key:s}=t;i=`${e}-${s}`,o=P(_.contrastIssues);break}case"color":{const{section:e,color:s}=t;i=`${e}-${s}`,o=`${s.toUpperCase()} (${e})`;break}case"unused-declarations":{const{declaration:e}=t;i=`${e}`,o=`${e}`;break}case"media-queries":{const{text:e}=t;i=`${e}`,o=`${e}`;break}case"font-info":{const{name:e}=t;i=`${e}`,o=`${e}`;break}}let s=this.#S.get(i);if(!s){if(!this.#w||!this.#f)throw new Error("Unable to initialize CSS overview, missing models");s=new B(this.#n,this.#w,this.#f,this.#b),s.populateNodes(t.nodes),this.#S.set(i,s)}this.#m.appendTab(i,o,s,!0)}#A(e){const t=Array.from(e.entries());return n.Fragment.Fragment.build`
  ...
  ${this.#L(i,"font-info","value",o)}
    ...
    ${s.map((([e,s])=>{const a=100*s.length/r,l=P(_.nOccurrences,{n:s.length});return n.Fragment.Fragment.build`<li>
  ...
  `}#O(e,t){console.assert(t.length>0);let i=t[0];for(const e of t)Math.abs(e.contrastRatio)<Math.abs(i.contrastRatio)&&(i=e);const s=i.textColor.asString("hexa"),r=i.backgroundColor.asString("hexa"),a=o.Runtime.experiments.isEnabled("apca"),l=P(_.textColorSOverSBackgroundResults,{PH1:s,PH2:r,PH3:t.length}),d=n.Fragment.Fragment.build`<li>
      ...
      <div class="block-title">
        <div class="contrast-warning hidden" $="aa"><span class="threshold-label">${P(_.aa)}</span></div>
        <div class="contrast-warning hidden" $="aaa"><span class="threshold-label">${P(_.aaa)}</span></div>
        <div class="contrast-warning hidden" $="apca"><span class="threshold-label">${P(_.apca)}</span></div>
      </div>
    </li>`;if(a){const e=d.$("apca");i.thresholdsViolated.apca?e.appendChild(j()):e.appendChild(H()),e.classList.remove("hidden")}else{const e=d.$("aa");i.thresholdsViolated.aa?e.appendChild(j()):e.appendChild(H());const t=d.$("aaa");i.thresholdsViolated.aaa?t.appendChild(j()):t.appendChild(H()),e.classList.remove("hidden"),t.classList.remove("hidden")}const c=d.$("color");return c.style.backgroundColor=r,c.style.color=s,c.style.border=D(i.backgroundColor.asLegacyColor()),d}#T(t,i){const o=n.Fragment.Fragment.build`<li>
    ...
    </li>`,s=o.$("color");s.style.backgroundColor=i;const r=e.Color.parse(i)?.asLegacyColor();if(r)return s.style.border=D(r),o}#M(t){return Array.from(t.keys()).sort(((t,i)=>{const o=e.Color.parse(t)?.asLegacyColor(),s=e.Color.parse(i)?.asLegacyColor();return o&&s?e.ColorUtils.luminance(s.rgba())-e.ColorUtils.luminance(o.rgba()):0}))}setOverviewData(e){this.#r(e)}static pushedNodes=new Set}class z extends(e.ObjectWrapper.eventMixin(n.Widget.VBox)){#R;constructor(){super(),this.#R=new n.TabbedPane.TabbedPane,this.#R.show(this.element),this.#R.addEventListener(n.TabbedPane.Events.TabClosed,(()=>{this.dispatchEventToListeners("TabClosed",this.#R.tabIds().length)}))}appendTab(e,t,i,o){this.#R.hasTab(e)||this.#R.appendTab(e,t,i,void 0,void 0,o),this.#R.selectTab(e)}closeTabs(){this.#R.closeTabs(this.#R.tabIds())}}class B extends n.Widget.Widget{#n;#w;#f;#b;#V;#_;constructor(e,t,i,o){super(),this.#n=e,this.#w=t,this.#f=i,this.#b=o,this.#V=[{id:"node-id",title:P(_.element),sortable:!0,weight:50,titleDOMFragment:void 0,sort:void 0,align:void 0,width:void 0,fixedWidth:void 0,editable:void 0,nonSelectable:void 0,longText:void 0,disclosure:void 0,allowInSortByEvenWhenHidden:void 0,dataType:void 0,defaultWeight:void 0},{id:"declaration",title:P(_.declaration),sortable:!0,weight:50,titleDOMFragment:void 0,sort:void 0,align:void 0,width:void 0,fixedWidth:void 0,editable:void 0,nonSelectable:void 0,longText:void 0,disclosure:void 0,allowInSortByEvenWhenHidden:void 0,dataType:void 0,defaultWeight:void 0},{id:"source-url",title:P(_.source),sortable:!1,weight:100,titleDOMFragment:void 0,sort:void 0,align:void 0,width:void 0,fixedWidth:void 0,editable:void 0,nonSelectable:void 0,longText:void 0,disclosure:void 0,allowInSortByEvenWhenHidden:void 0,dataType:void 0,defaultWeight:void 0},{id:"contrast-ratio",title:P(_.contrastRatio),sortable:!0,weight:25,titleDOMFragment:void 0,sort:void 0,align:void 0,width:"150px",fixedWidth:!0,editable:void 0,nonSelectable:void 0,longText:void 0,disclosure:void 0,allowInSortByEvenWhenHidden:void 0,dataType:void 0,defaultWeight:void 0}],this.#_=new d.SortableDataGrid.SortableDataGrid({displayName:P(_.cssOverviewElements),columns:this.#V,editCallback:void 0,deleteCallback:void 0,refreshCallback:void 0}),this.#_.element.classList.add("element-grid"),this.#_.element.addEventListener("mouseover",this.#N.bind(this)),this.#_.setStriped(!0),this.#_.addEventListener("SortingChanged",this.#P.bind(this)),this.#_.asWidget().show(this.element)}#P(){const e=this.#_.sortColumnId();if(!e)return;const t=d.SortableDataGrid.SortableDataGrid.StringComparator.bind(null,e);this.#_.sortNodes(t,!this.#_.isSortOrderAscending())}#N(e){const t=e.composedPath().find((e=>e.dataset&&e.dataset.backendNodeId));if(!t)return;const i=Number(t.dataset.backendNodeId);this.#n.dispatchEventToListeners("RequestNodeHighlight",i)}async populateNodes(e){if(this.#_.rootNode().removeChildren(),!e.length)return;const[t]=e,i=new Set;let o;if("nodeId"in t&&t.nodeId&&i.add("node-id"),"declaration"in t&&t.declaration&&i.add("declaration"),"sourceURL"in t&&t.sourceURL&&i.add("source-url"),"contrastRatio"in t&&t.contrastRatio&&i.add("contrast-ratio"),"nodeId"in t&&i.has("node-id")){const t=e.reduce(((e,t)=>{const i=t.nodeId;return W.pushedNodes.has(i)?e:(W.pushedNodes.add(i),e.add(i))}),new Set);o=await this.#w.pushNodesByBackendIdsToFrontend(t)}for(const t of e){let e;if("nodeId"in t&&i.has("node-id")){if(!o)continue;if(e=o.get(t.nodeId),!e)continue}const s=new U(t,e,this.#b,this.#f);s.selectable=!1,this.#_.insertChild(s)}this.#_.setColumnsVisiblity(i),this.#_.renderInline(),this.#_.wasShown()}}class U extends d.SortableDataGrid.SortableDataGridNode{#b;#f;#D;constructor(e,t,i,o){super(e),this.#D=t,this.#b=i,this.#f=o}createCell(t){const i=this.#D;if("node-id"===t){const o=this.createTD(t);if(o.textContent="...",!i)throw new Error("Node entry is missing a related frontend node.");return e.Linkifier.Linkifier.linkify(i).then((e=>{o.textContent="",e.dataset.backendNodeId=i.backendNodeId().toString(),o.appendChild(e);const t=new l.Icon.Icon;t.data={iconName:"select-element",color:"var(--icon-show-element)",width:"16px"},t.classList.add("show-element"),n.Tooltip.Tooltip.install(t,P(_.showElement)),t.tabIndex=0,t.onclick=()=>i.scrollIntoView(),o.appendChild(t)})),o}if("source-url"===t){const e=this.createTD(t);if(this.data.range){const t=this.#W(this.#f,this.#b,this.data.styleSheetId,a.TextRange.TextRange.fromObject(this.data.range));t&&""!==t.textContent?e.appendChild(t):e.textContent="(unable to link)"}else e.textContent="(unable to link to inlined styles)";return e}if("contrast-ratio"===t){const e=this.createTD(t),i=o.Runtime.experiments.isEnabled("apca"),s=r.NumberUtilities.floor(this.data.contrastRatio,2),a=i?s+"%":s,l=D(this.data.backgroundColor),d=this.data.textColor.asString(),c=this.data.backgroundColor.asString(),h=n.Fragment.Fragment.build`
      ...
      `,u=h.$("container");return i?(u.append(n.Fragment.Fragment.build`<span>${P(_.apca)}</span>`.element()),this.data.thresholdsViolated.apca?u.appendChild(j()):u.appendChild(H())):(u.append(n.Fragment.Fragment.build`<span>${P(_.aa)}</span>`.element()),this.data.thresholdsViolated.aa?u.appendChild(j()):u.appendChild(H()),u.append(n.Fragment.Fragment.build`<span>${P(_.aaa)}</span>`.element()),this.data.thresholdsViolated.aaa?u.appendChild(j()):u.appendChild(H())),e.appendChild(h.element()),e}return super.createCell(t)}#W(e,i,o,s){const n=e.styleSheetHeaderForId(o);if(!n)return;const r=n.lineNumberInSource(s.startLine),a=n.columnNumberInSource(s.startLine,s.startColumn),l=new t.CSSModel.CSSLocation(n,r,a);return i.linkifyCSSLocation(l)}}function j(){const e=new l.Icon.Icon;return e.data={iconName:"clear",color:"var(--icon-error)",width:"14px",height:"14px"},e}function H(){const e=new l.Icon.Icon;return e.data={iconName:"checkmark",color:"var(--icon-checkmark-green)",width:"14px",height:"14px"},e}var G=Object.freeze({__proto__:null,CSSOverviewCompletedView:W,DetailsView:z,ElementDetailsView:B,ElementNode:U});const q=new CSSStyleSheet;q.replaceSync(".css-overview-panel{overflow:hidden}devtools-css-overview-start-view{overflow:auto}\n/*# sourceURL=cssOverview.css */\n");class Q extends n.Panel.Panel{#n;#z;#B;#U;#j;#H;#G;#q;#Q;#K;#J;#X;#Y;#Z;#ee;constructor(e){super("css-overview"),this.element.classList.add("css-overview-panel"),this.#n=e,this.#z=new u.CSSOverviewStartView.CSSOverviewStartView,this.#z.addEventListener("overviewstartrequested",(()=>this.#n.dispatchEventToListeners("RequestOverviewStart"))),this.#B=new M(this.#n),this.#U=new W(this.#n),t.TargetManager.TargetManager.instance().observeTargets(this),this.#n.addEventListener("RequestOverviewStart",(e=>{p.userMetrics.actionTaken(p.UserMetrics.Action.CaptureCssOverviewClicked),this.#te()}),this),this.#n.addEventListener("OverviewCompleted",this.#ie,this),this.#n.addEventListener("Reset",this.#d,this),this.#n.addEventListener("RequestNodeHighlight",this.#oe,this),this.#d()}targetAdded(e){if(e!==t.TargetManager.TargetManager.instance().primaryPageTarget())return;this.#U.initializeModels(e);const i=e.model(C);this.#j=i}targetRemoved(){}#se(){if(!this.#j)throw new Error("Did not retrieve model information yet.");return this.#j}#d(){this.#H=new Map,this.#G=new Map,this.#q=new Map,this.#Q=new Map,this.#K=new Map,this.#J=new Map,this.#X=new Map,this.#Y=0,this.#Z={styleRules:0,inlineStyles:0,externalSheets:0,stats:{type:0,class:0,id:0,universal:0,attribute:0,nonSimple:0}},this.#ee=new Map,this.#ne()}#oe(e){this.#se().highlightNode(e.data)}#ne(){this.#B.hideWidget(),this.#U.hideWidget(),this.contentElement.append(this.#z),this.#z.show()}#re(){this.#z.hide(),this.#U.hideWidget(),this.#B.show(this.contentElement)}#ae(){this.#z.hide(),this.#B.hideWidget(),this.#U.show(this.contentElement),this.#U.setOverviewData({backgroundColors:this.#H,textColors:this.#G,textColorContrastIssues:this.#ee,fillColors:this.#q,borderColors:this.#Q,globalStyleStats:this.#Z,fontInfo:this.#K,elementCount:this.#Y,mediaQueries:this.#J,unusedDeclarations:this.#X})}async#te(){this.#re();const e=this.#se(),[t,{elementCount:i,backgroundColors:o,textColors:s,textColorContrastIssues:n,fillColors:r,borderColors:a,fontInfo:l,unusedDeclarations:d},c]=await Promise.all([e.getGlobalStylesheetStats(),e.getNodeStyleStats(),e.getMediaQueries()]);i&&(this.#Y=i),t&&(this.#Z=t),c&&(this.#J=c),o&&(this.#H=o),s&&(this.#G=s),n&&(this.#ee=n),r&&(this.#q=r),a&&(this.#Q=a),l&&(this.#K=l),d&&(this.#X=d),this.#n.dispatchEventToListeners("OverviewCompleted")}#ie(){this.#ae()}wasShown(){super.wasShown(),this.registerCSSFiles([q])}}var K=Object.freeze({__proto__:null,CSSOverviewPanel:Q});export{G as CSSOverviewCompletedView,m as CSSOverviewController,y as CSSOverviewModel,K as CSSOverviewPanel,T as CSSOverviewProcessingView,V as CSSOverviewSidebarPanel,S as CSSOverviewUnusedDeclarations};
