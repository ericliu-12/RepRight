        ...
        <div class="wrapper">
          <div class="header" jslog=${R.toolbar()}>
            ...
            <${l.ShortcutDialog.ShortcutDialog.litTagName}
              .data=${{shortcuts:this.#H()}} jslog=${R.action("show-shortcuts").track({click:!0})}
            ></${l.ShortcutDialog.ShortcutDialog.litTagName}>
          </div>
